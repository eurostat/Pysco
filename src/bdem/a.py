...
def building_demography_grid(buildings_loader, bbox, out_folder, out_file, resolution=1000, partition_size = 50000, nb_floors_fun=lambda f:1, residential_fun=lambda f:0, cultural_value_fun=lambda f:0, crs = 'EPSG:3035'):
