...
def accessiblity_grid_k_nearest_dijkstra(xy,
            ...
            road_network_loader,
            k,
            weight_function_positive,
            weight_function_negative,
    ...
    gb_ = ___graph_adjacency_list_from_geodataframe(roads,
                                                        weight_fun_pos = weight_function_positive,
                                                        weight_fun_neg = weight_function_negative,
...
def accessiblity_grid_k_nearest_dijkstra_parallel(
        ...
        out_folder,
        k = 3,
        weight_function_positive = lambda feature,sl:sl,
        weight_function_negative = lambda feature,sl:sl,
